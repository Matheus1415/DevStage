...
const subscriptionSchman = z.object({
  name: z.string().min(2, "Digite seu nome completo"),
  email: z.string().email("Digite um e-mail válido"),
});

type SubScriptionSchman = z.infer<typeof subscriptionSchman>;
...
export function SubScriptionForm() {
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<SubScriptionSchman>({
    resolver: zodResolver(subscriptionSchman),
  });

  function onSubscription(data: SubScriptionSchman) {
    console.log(data);
  }
